...
import com.etrouve.egestion.fragment.superadmin.SuperAcceuilFragment;
...
public class MainSuperadminActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_superadmin);
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Backendless.initApp(this, APP_ID, SECRET_KEY, VERSION);
        getSharedPreferences = getSharedPreferences("PreferencesTAG", Context.MODE_PRIVATE);
        progressDialog = new ProgressDialog(MainSuperadminActivity.this,R.style.Custom);
    ...
    private void defaultFragment() {
        fragmentClass = SuperAcceuilFragment.class;
        try {
