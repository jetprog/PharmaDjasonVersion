...
import com.etrouve.egestion.dialogs.DialogAddStock;
import com.etrouve.egestion.dialogs.DialogAddUniteEntreprise;
import com.etrouve.egestion.dialogs.DialogAddUser;
import com.etrouve.egestion.fragment.ListeCategorieFragment;
import com.etrouve.egestion.fragment.ListeCommandeFragment;
import com.etrouve.egestion.fragment.ListeStockFragment;
import com.etrouve.egestion.fragment.ListeUniteEntrepriseFragment;
import com.etrouve.egestion.fragment.ListeUserFragment;
import com.etrouve.egestion.fragment.admin.AdminAccueilFragment;
...
public class MainAdminActivity extends AppCompatActivity
    ...
    // si erreur utiliser variable avec static pour recuperer dans Fragment
    // public static String telephoneLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(MainAdminActivity.this,R.style.Custom);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(titleFrag.equals("Liste Utilisateur")){
                    FragmentManager fm = getSupportFragmentManager();
                    DialogAddUser dialog_add_user = DialogAddUser.newInstance("Enregistrer Utilisateur: ");
                    dialog_add_user.show(fm, "dialog_add_user");
                }
                else if(titleFrag.equals("Categorie Produit")){
                    FragmentManager fm = getSupportFragmentManager();
                ...
                else if(titleFrag.equals("Unite Entreprise")){
                    FragmentManager fm = getSupportFragmentManager();
                    DialogAddUniteEntreprise dialog_add_unite_entreprise = DialogAddUniteEntreprise.newInstance("Enregistrer Unité de vente: ");
                    dialog_add_unite_entreprise.show(fm, "dialog_add_unite_entreprise");
                }
                else if(titleFrag.equals("Gestion Stock")){
                    FragmentManager fm = getSupportFragmentManager();
                    DialogAddStock dialog_add_stock = DialogAddStock.newInstance("Enregistrer Stock: ");
                    dialog_add_stock.show(fm, "dialog_add_stock");
                }
                else{
                    Snackbar.make(view, "Vous n'avez pas l'autorisation...", Snackbar.LENGTH_LONG)
    ...
    private void defaultFragment() {
        fragmentClass = AdminAccueilFragment.class;
        try {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.nav_unite:
                ...
                break;
            case R.id.nav_gestion_stock:
                fragmentClass = ListeStockFragment.class;
                break;
            case R.id.nav_rapport:
                Toast.makeText(getApplicationContext(),"Pas encore disponible",Toast.LENGTH_LONG).show();
